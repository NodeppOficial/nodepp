...
namespace nodepp { namespace ssl {
...
public:
    ...
    ssl_t( ssl_t& xtc, int df ) : obj( new NODE() ) { ssl::start_device();
    ...
    ssl_t() noexcept : obj( new NODE() ) { ssl::start_device(); }
