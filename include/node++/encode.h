...
namespace encode {
      ...
      string_t get( string_t from, string_t to, string_t message ){
            return nodepp::_encode_( from, to, message );
      }

      string_t get_16( string_t from, string_t to, string_t message ){
            return nodepp::_encode_( from, to, message, sizeof(char16_t) );
      }

      string_t get_32( string_t from, string_t to, string_t message ){
